                        ...
                        <?php 
                            ...
                            elseif(isset($_POST['pe_id'])){
                                ...
                                if (isset($_POST['add'])) {
                                    ...
                                    $sql = "INSERT INTO jabatan VALUES ('', '$pe_id', '$jb_jenis_instansi', '$pa_id', '$jb_nama_jabatan', '$jb_nama_unit', '$jb_status_jabatan', '$jb_tmt_golongan', '$jb_no_sk_pengangkatan', '$jb_tanggal_sk_pengangkatan', '$jb_tmt_pengangkatan', '$jb_aktif_jabatan', '$jb_no_sk_pemberhentian', '$jb_tanggal_sk_pemberhentian', '$jb_tmt_pemberhentian')";
